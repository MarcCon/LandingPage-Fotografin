...
const HeaderHomePage = () => {
  return (
    <div className="h-[800px] bg-[url('/HeaderBildHelene.jpg')] bg-cover bg-center bg-no-repeat">
      <div className=" grid h-full grid-rows-3	">
        <div></div>
        <div className=" ml-32 font-serif text-7xl  text-white sm:text-4xl md:text-5xl lg:text-6xl  xl:text-7xl 2xl:text-7xl">
